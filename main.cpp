...
void all::enter_patient_info(){
 ...
 for(i=serial;answer=='y'||answer=='Y';i++){
  ...
  if(PI[i].martial_status<1||PI[i].martial_status>2){
...
if(PI[i].bld_group!=1&&PI[i].bld_group!=2&&PI[i].bld_group!=3&&
...
void dob::enter_date(){
 ...
 switch(DOB11[temp].month){
  ...
  case 12:{
           cin>>DOB11[temp].date;
           if(DOB11[temp].date<1||DOB11[temp].date>31){
            cout<<"\n\n";
            cout<<"Invalid date !"<<"\n\n";
  ...
  case 2:{
          ...
          if(DOB11[temp].year%4==0){
           if(DOB11[temp].date<0||DOB11[temp].date>29){
            cout<<"\n\n";
            cout<<"Invalid date !"<<"\n\n";
            cout<<"Again enter the date :"<<"\n\n";
            cout<<"\n\n";
           ...
           if(DOB11[temp].date<0||DOB11[temp].date>28){
            cout<<"\n\n";
            cout<<"Invalid date !"<<"\n\n";
            cout<<"Again enter the date :"<<"\n\n";
            cout<<"\n\n";
 ...
 default:{
          cin>>DOB11[temp].date;
          if(DOB11[temp].date<1||DOB11[temp].date>30){
           cout<<"\n\n";
           cout<<"Invalid date !"<<"\n\n";
           cout<<"Again enter the date :"<<"\n\n";
           cout<<"\n\n";
...
void all::software_detail(){
 ...
 cout<<" Programming code   : C++ "<<"\n\n";
 cout<<" Aim                      : Hospital Management system"<<"\n\n";
 cout<<" Developed by Carlson Kamau Kuria"<<"\n\n";
 cout<<" system version ck001 "<<"\n\n";
